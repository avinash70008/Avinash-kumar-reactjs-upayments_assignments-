...
import { getCategories, showCreateModal, createProduct, getProducts } from "../../Redux/CreatePro/action";
...
const CreateProduct = () => {
  ...
  const categories = useSelector((state) => state.AddproductsReducer.categories);
  const postResponse = useSelector((state) => state.AddproductsReducer.postResponse);
